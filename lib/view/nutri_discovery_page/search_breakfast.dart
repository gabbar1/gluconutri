...
class NutriSearchBreakfastPage extends StatefulWidget {
  const NutriSearchBreakfastPage({Key? key}) : super(key: key);

  @override
  State<NutriSearchBreakfastPage> createState() => _NutriSearchBreakfastPageState();
}

class _NutriSearchBreakfastPageState extends State<NutriSearchBreakfastPage> {
  @override
